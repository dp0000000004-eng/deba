...
const NavIcons = () => {
    ...
    const mailTo = "mailto:dp0000000004@gmail.com"
    const github = "https://github.com/dp0000000004-eng"
    const linkedin = "https://www.linkedin.com/in/debasish-p-d1"
    const medium = "https://medium.com/@debasishpradhan044"

    return (
        <div className="nav-icons" is="nav-icons">
